...
//!
//! Run: cargo run --example full_agent -p coding-tools-rig

use coding_tools_rig::absolute::{EditTool, GlobTool, GrepTool, ReadTool, WriteTool};
use coding_tools_rig::{BashTool, PreambleBuilder, TodoTools, WebFetchTool};
