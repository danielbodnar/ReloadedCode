...
//!
//! Run: cargo run --example sandboxed -p coding-tools-rig

use coding_tools_rig::allowed::{EditTool, GlobTool, GrepTool, ReadTool, WriteTool};
use coding_tools_rig::{AllowedPathResolver, PreambleBuilder};
